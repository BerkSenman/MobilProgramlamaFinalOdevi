...
public class RegisterActivity extends AppCompatActivity {
    ...
    private TextView registerKullaniciAdi;
    private TextView registerSifre;
    ...
    public void customerRegister(View v) {
        ...
        String username = registerKullaniciAdi.getText().toString();
        String password = registerSifre.getText().toString();
