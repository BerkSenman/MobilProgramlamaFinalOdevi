...
public class UserDetailActivity extends AppCompatActivity {
    ...
    private EditText detailKullaniciAdi, detailKullaniciSoyad;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        detailKullaniciAdi = findViewById(R.id.detailKullaniciAdi);
        detailKullaniciSoyad = findViewById(R.id.detailKullaniciSoyad);
    ...
    public void initCustomer() {
        ...
        call.enqueue(new Callback<Customer>() {
            ...
            public void onResponse(Call<Customer> call, Response<Customer> response) {
                ...
                detailKullaniciAdi.setText(customer.firstName);
                detailKullaniciSoyad.setText(customer.lastName);
    ...
    public void updateCustomer(View v){
        String firstName = detailKullaniciAdi.getText().toString();
        String lastName = detailKullaniciSoyad.getText().toString();
